const videoLoadingText = document.querySelector(".video-loading"); 
const videoContainer = document.querySelector(".video-container");
const iframeVideoSource = document.querySelector("#id_iframeVideoSource");
...
const videoList = [
    {
        title: "Bunga Nila",
        src: "https://drive.google.com/file/d/1osV-4kfp83OmNGY2oFhyLePaPOwuAYqk/preview"
    },
    {
        title: "The Safe House",
        src: "files/vids/The Safe House.mp4"
    },
    {
        title: "The Road to Contrition",
        src: "files/vids/Road to Contrition.mp4"
    }
]
